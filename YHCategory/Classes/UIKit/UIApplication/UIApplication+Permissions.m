...
-(CLLocationManager *)yh_permissionsLocationManager {
    return objc_getAssociatedObject(self, &SIPermissionsLocationManagerPropertyKey);
}

-(void)setyh_permissionsLocationManager:(CLLocationManager *)manager {
...
-(void)setyh_locationSuccessCallbackProperty:(SILocationSuccessCallback)locationCallbackProperty {
...
-(void)setyh_locationFailureCallbackProperty:(SILocationFailureCallback)locationFailureCallbackProperty {
